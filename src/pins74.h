...
// //---------------------------------------------------------------------------
// // ESP32 OLED3 box shield --- WH v3 plate //double side//

// #define CLK_595 18  // YELLOW //Pin 74hc595 --- 11 cp
// #define CS_595 17   // GREEN //Pin 74hc595 --- 12 shcp latch
// #define DAT_595 16 // TRANPARENT //Pin 74hc595 --- 14 data_pin_in

// // 1conn GND
// // 2pin Vcc +3.3v
// const int clk_pin = 18; //4conn // CL pin 2 
// const int shld_pin = 15; //6conn //PL 1
// const int data_pin = 14; //5conn // SW_DATA 9
// // 6pin Vcc +3.3v
// // 74hc165
